const booleanKeys = new Set(['adBlocker', 'proxyEnabled', 'webhookEnabled', 'displayWhenIdling', 'displaySCSmallIcon', 'discordRichPresence', 'displayButtons', 'minimizeToTray', 'navigationControlsEnabled', 'trackParserEnabled', 'richPresencePreviewEnabled', 'hidePromotions', 'hideEventsNearYou', 'hideArtistUpsells']);
type BooleanKey = 'adBlocker' | 'proxyEnabled' | 'webhookEnabled' | 'displayWhenIdling' | 'displaySCSmallIcon' | 'discordRichPresence' | 'displayButtons' | 'minimizeToTray' | 'navigationControlsEnabled' | 'trackParserEnabled' | 'richPresencePreviewEnabled' | 'hidePromotions' | 'hideEventsNearYou' | 'hideArtistUpsells';
