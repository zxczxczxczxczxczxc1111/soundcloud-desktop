...
<sub>Версия 0.6.0 для Windows 10 и 11 x64</sub>
...
Бери установщик `soundcloud-desktop-0.6.0-setup-x64.exe` на странице [последнего релиза](https://github.com/zxczxczxczxczxczxc1111/soundcloud-desktop/releases/latest). Рядом лежит `SHA256SUMS`, если захочешь сверить файлы.
